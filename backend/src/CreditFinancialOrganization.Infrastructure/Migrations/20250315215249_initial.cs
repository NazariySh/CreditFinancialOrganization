    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CreditScores", x => x.CustomerId);
                    table.ForeignKey(
                        name: "FK_CreditScores_Users_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LoanApplications_Loans_Id",
                        column: x => x.Id,
                        principalTable: "Loans",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_LoanApplications_Users_EmployeeId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("a1b9c8f0-1d2e-43b2-b3d2-3c30b354697d"), null, "Employee", "EMPLOYEE" },
                    { new Guid("b3e1a5f0-9d4c-4c57-95c4-7a8f2b6d9e3f"), null, "Admin", "ADMIN" },
                    { new Guid("f4a3d9b2-28b9-4670-b7f5-07b6e5cf107f"), null, "Customer", "CUSTOMER" }
                });
